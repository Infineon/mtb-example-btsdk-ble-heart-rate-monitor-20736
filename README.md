# Bluetooth&#174; LE Heart Rate monitor Sample application

## Overview

This app implements a sample LE Heart Rate profile, service, application.
Refer to Bluetooth&#174; SIG Heart Rate Profile 1.0 and Heart Rate Service 1.0 specifications for details.
...
- Replacing ROM application functions with local ones
...
3. Use a CySmart application or similar one with heart rate monitor
